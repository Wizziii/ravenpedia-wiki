...
export default (() => {
    const Head: QuartzComponent = ({
        ...
        // Keyword logic
        const pageTitleAsKeyword = fileData.frontmatter?.title;
        const pageTags = fileData.frontmatter?.tags ?? [];
        const combinedKeywords = [...baseKeywords, pageTitleAsKeyword, ...pageTags].filter(Boolean); // Combine base keywords, the page title, and then the page tags. .filter(Boolean) cleanly removes any empty or undefined values (e.g., if a page has no title).
